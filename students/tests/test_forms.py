...
@pytest.fixture
def professor():
    return Professor.objects.create(first_name="Alan", last_name="Turing", email="alan@uni.com")

@pytest.fixture
def course(category, professor):
    return Course.objects.create(name="Algorithms", code="CS101", category=category, professor=professor)
...
@pytest.mark.parametrize(
    ...
    [
        # No duplicate exists
        (None, {"first_name": "Bob", "last_name": "Marley", "student_id": "STU999"}, True, None),
...
def test_student_admin_form(existing_data, new_data, should_be_valid, error_msg, course):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"name": "Algorithms", "code": "CS101", "category_name": "CS", "professor_name": "Alan Turing"},
...
def test_course_admin_form(existing_data, new_data, should_be_valid, error_msg, category, professor):
